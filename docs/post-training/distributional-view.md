...
<a id="distributional-post-training"></a>
...
<a id="why-rl-forgets-less"></a>

## 五、为什么 RL 遗忘得更少

Blog 讨论了多种解释。它们都能解释一部分现象，但作者最终更倾向于 On-Policy Data。

<a id="forward-reverse-kl"></a>
...
<a id="student-outperform-teacher"></a>
